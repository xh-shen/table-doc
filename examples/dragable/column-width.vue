<template>
	<s-table :columns="columns" :data-source="dataSource" :pagination="false" @resize-column="onResizeColumn">
...
const onResizeColumn: STableProps['onResizeColumn'] = (w, col, action) => {
	console.log(w)
	console.log(col)
	console.log(action)
