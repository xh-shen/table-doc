<template>
	<s-table :columns="columns" :data-source="dataSource" :pagination="false" allow-column-drag @column-drag-end="onColumnDragEnd">
...
const onColumnDragEnd: STableProps['onColumnDragEnd'] = params => {
	console.log(params)
}
</script>
