<template>
	<ElButton style="margin-bottom: 10px" @click="onClear">清空选中</ElButton>
	<ElButton style="margin-bottom: 10px" @click="onSelected">选中2-3行</ElButton>
...
import { ElTag, ElSpace, ElButton } from 'element-plus'
